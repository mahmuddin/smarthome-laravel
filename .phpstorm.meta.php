    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Spatie\Multitenancy\TenantFinder\TenantFinder' => \App\MultiTenancy\TenantFinder\PathBasedTenantFinder::class,
    ...
    override(\config(), map([
            ...
            'database.connections.tenant.schema' => 'string',
            ...
            'database.connections.landlord.schema' => 'string',
            ...
            'filesystems.links.C:\laragon\www\my-project\SmartHome Management System\multi-tenancy\public\storage' => 'string',
            'jwt.secret' => 'string',
            ...
            'multitenancy.tenant_finder' => 'string',
            ...
            'multitenancy.tenant_database_connection_name' => 'string',
            'multitenancy.landlord_database_connection_name' => 'string',
            ...
            'multitenancy.tenant_migrations_paths' => 'array',
            'multitenancy.tasks' => 'array',
...
'database.connections.sqlsrv.password','database.connections.sqlsrv.charset','database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.tenant.driver',
...
'database.connections.tenant.charset','database.connections.tenant.prefix','database.connections.tenant.schema','database.connections.landlord.driver','database.connections.landlord.host',
'database.connections.landlord.port','database.connections.landlord.database','database.connections.landlord.username','database.connections.landlord.password','database.connections.landlord.schema',
'database.connections.landlord.charset','database.connections.landlord.prefix','database.migrations.table','database.migrations.update_date_on_publish','database.redis.client',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\my-project\\SmartHome Management System\\multi-tenancy\\public\\storage','jwt.secret','jwt.keys.public',
...
'multitenancy.queueable_to_job.Illuminate\\Broadcasting\\BroadcastEvent','multitenancy.tenant_aware_jobs','multitenancy.not_tenant_aware_jobs','multitenancy.tenant_migrations_paths','multitenancy.tasks',
...
'api.login','api.logout','api.me','api.tenants.store','storage.local',);
...
'DB_PASSWORD','DB_TENANT_CONNECTION','DB_DATABASE_LANDLORD','SESSION_DRIVER','SESSION_LIFETIME',
...
'VITE_APP_NAME','JWT_SECRET','AUTH_GUARD','JWT_TTL','JWT_REFRESH_TTL',);
